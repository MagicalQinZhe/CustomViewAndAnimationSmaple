 ...
 */
public class MediaPlayerControl extends FrameLayout implements ITestLayout, ITestAnimation {

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MediaPlayerControl(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public MediaPlayerControl(Context context, AttributeSet attrs, int defStyleAttr) {
